...
public class Circular_Queue {
    ...
    Circular_Queue(int capacity) throws QueueException{
    ...
    * @method we set the element we put the element at the last index
    * then we update the index of tail because it's circular queue from next method
    */
    ...
    /*@method we extract the element as queue it's (FIFO) data structure
    * the we update the index value of head because it's circular queue*/
